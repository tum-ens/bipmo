...
class SimpleBiogasPlantModel(object):
    """ Create a linear state-space model for a biogas power plant, given data about the plant.
        ...
        The main difference to the other BiogasPlantModel is the lack of modelling the fermentation process"""
    scenario_name: str
    states: pd.Index
    controls: pd.Index
    outputs: pd.Index
    ...
    def __init__(
        ...
        # Get biogas production rate (constant over tim)
        biogas_production_rate = float(self.plant_scenarios.loc[self.scenario_name, 'init_state_digester'])
        ...
        def discretize_model():
            ...
            control_matrix_part1 = self.control_matrix.loc[
                self.control_matrix.index == self.scenario_name + '_prod_biogas_m3_s-1']
            ...
            state_matrix_discrete.loc[
                self.scenario_name + '_prod_biogas_m3_s-1', self.scenario_name + '_prod_biogas_m3_s-1'] = \
            state_matrix_discrete_part1.tolist()[0][0]
